  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 flex items-center justify-center px-4 py-12">
      ...
      <div className="pointer-events-none fixed top-0 left-0 w-full h-full overflow-hidden">
        <div className="absolute -top-40 -right-40 w-96 h-96 bg-indigo-200 rounded-full opacity-25 blur-3xl" />
        <div className="absolute -bottom-40 -left-40 w-96 h-96 bg-blue-200 rounded-full opacity-25 blur-3xl" />
      </div>
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-white/70 backdrop-blur-xl rounded-3xl shadow-2xl shadow-indigo-100/60 border border-white/80 px-8 py-10">
          ...
          <div className="mb-8 text-center">
            ...
            <p className="mt-1 text-sm text-slate-500">Join Netzen today</p>
          </div>

          {/* Success banner */}
          {registered && (
            <div className="mb-5 flex items-center gap-3 rounded-2xl bg-emerald-50 border border-emerald-100 px-4 py-3">
              <svg className="w-4 h-4 text-emerald-500 shrink-0" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
              </svg>
              <p className="text-sm text-emerald-700 font-medium">Account created! Redirecting to login…</p>
            </div>
          )}
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className={`w-full rounded-xl border bg-white/80 px-4 py-2.5 text-sm text-slate-800 placeholder-slate-400 outline-none transition-all duration-200 focus:ring-2 focus:ring-indigo-400/40 focus:border-indigo-400 hover:border-slate-300 ${errors.fullName ? "border-red-300 bg-red-50/40" : "border-slate-200"}`}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="janedoe"
                  className={`w-full rounded-xl border bg-white/80 pl-8 pr-4 py-2.5 text-sm text-slate-800 placeholder-slate-400 outline-none transition-all duration-200 focus:ring-2 focus:ring-indigo-400/40 focus:border-indigo-400 hover:border-slate-300 ${errors.username ? "border-red-300 bg-red-50/40" : "border-slate-200"}`}
                  {...register("username", {
